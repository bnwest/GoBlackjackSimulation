...
// 2. Ownership via moving and borrowing happen implicily.  This is almost a deal breaker.
...
// 6. Global variable are nontrivial to initialize at run time (easy at compile time).
